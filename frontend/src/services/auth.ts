...
export const checkDetainedStatus = (
  rollNo: string
): { isDetained: boolean; message?: string } => {
  ...
  if (isDetained(rollNo)) {
    ...
    return {
      isDetained: true,
      message:
        "You have been detained for this academic year/semester and do not have access to this portal.",
    };
  }
