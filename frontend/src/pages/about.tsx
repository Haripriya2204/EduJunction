    ...
    <div className="min-h-screen bg-gray-900 text-white">
      <div className="container mx-auto py-12 px-4">
        <div className="bg-gray-800 p-8 rounded-lg shadow-lg">
          <h1 className="text-4xl font-bold mb-6 text-blue-500">About MLR Institute of Technology</h1>
          <p className="mb-6">
          ...
          <h2 className="text-3xl font-bold mt-8 mb-4 text-blue-500">Mission</h2>
          <p className="mb-6">
          ...
          <h2 className="text-3xl font-bold mt-8 mb-4 text-blue-500">About this Website</h2>
          <p className="mb-6">
            This website, edmit.mlrit.ac.in, is a platform for students to upload their fee receipts to be verified by administration and see and choose their courses.
          </p>
        </div>
      </div>
    </div>
